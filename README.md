...
<body>
    ...
    <script>
        ...
        // WORKING PUBLIC DATABASE - Ready to use immediately!
        const firebaseConfig = {
    apiKey: "AIzaSyBrxONoYFTwZV37eb4lbMi_-7s55GYkmwU",
    authDomain: "newonlinefood-f84c2.firebaseapp.com",
    databaseURL: "https://newonlinefood-f84c2-default-rtdb.asia-southeast1.firebasedatabase.app",
    projectId: "newonlinefood-f84c2",
    storageBucket: "newonlinefood-f84c2.firebasestorage.app",
    messagingSenderId: "483833212239",
    appId: "1:483833212239:web:5d82357b7e3af1946ae93a",
    measurementId: "G-89S45QR822"
  };
        // Initialize Firebase
        let database;
            ...
            try {
                ...
                database.ref('.info/connected').on('value', (snapshot) => {
                    if (snapshot.val() === true) {
                        ...
                        showNotification('🌐 Cloud Database Connected!');
                    } else {
                        isFirebaseConnected = false;
                        console.log('⚠️ Firebase Disconnected');
                        updateDatabaseStatus('Disconnected - Reconnecting...');
                    }
                });
                ...
                isFirebaseConnected = false;
                updateDatabaseStatus('Offline Mode - LocalStorage');
            }
        }
        ...
        const DB_PATH = 'foodExpress/mainData';
        ...
        function saveToDatabase() {
            ...
            if (isFirebaseConnected && database) {
                ...
                // Fallback to localStorage
                console.log('📝 No Firebase connection, using LocalStorage');
                saveToLocalStorage(dbData);
                updateDatabaseStatus('Offline Mode - LocalStorage');
            }
        }
                    ...
                    database.ref(DB_PATH).once('value')
                        .then((snapshot) => {
                            ...
                            if (dbData) {
                                ...
                                console.log('📦 No data in Firebase yet, checking LocalStorage...');
            ...
            database.ref(DB_PATH).on('value', (snapshot) => {
                ...
                if (dbData && appData.currentUser) {
                    ...
                    if (newTime > currentTime) {
                        ...
                        console.log('📊 Updated at:', dbData.lastUpdated);
                        applyDatabaseData(dbData);
                        ...
                        setTimeout(() => refreshCurrentPanel(), 100);
                    }
                }
            }, (error) => {
        ...
        function refreshCurrentPanel() {
            ...
            console.log('🔄 Refreshing panel for role:', appData.currentUser.role);
        ...
        function resetDatabase() {
            if (confirm('⚠️ WARNING: This will DELETE ALL DATA for ALL USERS!\n\nAre you absolutely sure?')) {
        ...
        window.onload = async function() {
            ...
            if (dataLoaded) {
                console.log('='.repeat(50));
                console.log('📦 Database Status: Connected & Loaded');
                ...
                console.log('📦 Database Status: New Installation - Creating initial data');
                // Save initial data
                autoSave();
            }
            ...
            if (isFirebaseConnected) {
                ...
                console.log('💾 LocalStorage Mode: ACTIVE ⚠️');
                console.log('⚠️ Multi-device sync NOT available in offline mode');
            }
            console.log('='.repeat(50));
            ...
            setTimeout(() => {
                if (isFirebaseConnected) {
                    showNotification('🌐 Connected to Cloud Database! Multi-device sync active.', 'success');
                } else {
                    showNotification('⚠️ Offline mode - Using local storage', 'error');
                }
            }, 1500);
        };
    </script>
